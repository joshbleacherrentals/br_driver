// Enriched WorkTrackers with pickup/dropoff addresses and bleacher data
// export const enrichedWorkTrackers$ = computed(() => {
//   const trackers = workTrackers$.get();
//   const addressesRaw = workTrackerAddresses$.get();
//   const bleachersRaw = workTrackerBleachers$.get();
